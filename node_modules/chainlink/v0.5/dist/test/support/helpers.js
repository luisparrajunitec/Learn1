...
exports.BNtoUint8Array = (n) => Uint8Array.from(new bn_js_1.default(n).toArray('be', 32));
...
exports.newUint8ArrayFromDecimal = (str, count) => {
    ...
    const hexStr = new bn_js_1.default(str, 10).toString(16).padStart(hexCount, '0');
    assert(hexStr.length <= hexCount, `${str} won't fit in ${count} bytes`);
...
exports.encodeServiceAgreement = (sa) => {
    const saParams = [
        sa.payment.toString(),
...
exports.initiateServiceAgreementArgs = (serviceAgreement) => {
    ...
    return [
        exports.encodeServiceAgreement(serviceAgreement),
        exports.encodeOracleSignatures(signatures),
    ];
};
// Call coordinator contract to initiate the specified service agreement, and
// get the return value
exports.initiateServiceAgreementCall = async (coordinator, serviceAgreement) => await coordinator.initiateServiceAgreement.call(...exports.initiateServiceAgreementArgs(serviceAgreement));
/** Call coordinator contract to initiate the specified service agreement. */
exports.initiateServiceAgreement = async (coordinator, serviceAgreement) => coordinator.initiateServiceAgreement(...exports.initiateServiceAgreementArgs(serviceAgreement));
...
exports.newServiceAgreement = async (params) => {
    const agreement = {};
    params = params || {};
    agreement.payment = params.payment || new bn_js_1.default('1000000000000000000', 10);
    agreement.expiration = params.expiration || new bn_js_1.default(300);
...
function sixMonthsFromNow() {
    return new bn_js_1.default(Math.round(Date.now() / 1000.0) + 6 * 30 * 24 * 60 * 60);
}
...
exports.encodeUint256 = (int) => exports.hexPadUint256(new bn_js_1.default(int));
exports.encodeInt256 = (int) => exports.hexPadUint256(new bn_js_1.default(int).toTwos(256));
