...
export declare const BNtoUint8Array: (n: BN) => Uint8Array;
...
export declare const toWei: (num: import("ethers/providers").BlockTag) => any;
...
export declare const assertActionThrows: (action: any, messageContains?: RegExp | undefined) => Promise<void>;
...
export declare const encodeServiceAgreement: (sa: ServiceAgreement) => any;
export declare const encodeOracleSignatures: (os: OracleSignatures) => any;
export declare const initiateServiceAgreementArgs: (serviceAgreement: ServiceAgreement) => any[];
...
export declare function sixMonthsFromNow(): BN;
...
declare type numeric = number | BN;
export declare const hexPadUint256: (n: BN) => string;
export declare const encodeUint256: (int: numeric) => string;
export declare const encodeInt256: (int: numeric) => string;
