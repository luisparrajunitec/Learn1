...
interface PrepaidAggregatorInterface extends Interface {
  functions: {
...
export class PrepaidAggregator extends Contract {
  connect(signerOrProvider: Signer | Provider | string): PrepaidAggregator;
  attach(addressOrName: string): PrepaidAggregator;
  deployed(): Promise<PrepaidAggregator>;

  on(event: EventFilter | string, listener: Listener): PrepaidAggregator;
  once(event: EventFilter | string, listener: Listener): PrepaidAggregator;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): PrepaidAggregator;
  removeAllListeners(eventName: EventFilter | string): PrepaidAggregator;
  removeListener(eventName: any, listener: Listener): PrepaidAggregator;

  interface: PrepaidAggregatorInterface;
