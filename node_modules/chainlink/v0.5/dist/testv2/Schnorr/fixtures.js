...
exports.bn = ethers_1.ethers.utils.bigNumberify;
test_helpers_1.extensions.ethers.BigNumber.extend();
// Number of points in secp256k1
exports.groupOrder = exports.bn('0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141');
exports.secretKey = exports.bn(
...
exports.publicKey = [
    ...
    exports.bn('0x6e071bbc2060bce7bae894019d30bdf606bdc8ddc99d5023c4c73185827aeb01'),
    exports.bn('0x9ed10348aa5cb37be35802226259ec776119bbea355597db176c66a0f94aa183'),
];
_a = [
    // Arbitrary values to test signature
    exports.bn('0x18f224412c876d8efb2a3fa670837b5ad1347120363c2b310653f610d382729b'),
    exports.bn('0xd51e13c68bf56155a83e50fd9bc840e2a1847fb9b49cd206a577ecd1cd15e285'),
], exports.msgHash = _a[0], exports.k = _a[1];
exports.kTimesG = [
    // >>> print("'0x%x',\n'0x%x'" % tuple(s.multiply(s.G, k)))
    // note that a 04 prefix was added to denote that this is a uncompressed point
    exports.bn('0x6c8644d3d376356b540e95f1727b6fd99830d53ef8af963fcc401eeb7b9f8c9f'),
    // note that the leading 0x hex prefix was stripped
    exports.bn('0xf142b3c0964202b45fb2f862843f75410ce07de04643b28b9ce04633b5fb225c'),
];
exports.kTimesGAddress = test_helpers_1.helpers.pubkeyToAddress(exports.kTimesG);
exports.pubKeyYParity = exports.publicKey[1].isEven() ? 0 : 1;
exports.e = exports.bn(ethers_1.ethers.utils.solidityKeccak256(['uint256', 'uint8', 'uint256', 'uint160'], [exports.publicKey[0], exports.pubKeyYParity ? '0x01' : '0x00', exports.msgHash, exports.kTimesGAddress]));
exports.s = exports.k.sub(exports.e.mul(exports.secretKey)).umod(exports.groupOrder); // s ≡ k - e*secretKey mod groupOrder
